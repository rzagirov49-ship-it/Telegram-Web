...
class TlBinaryReader {
  ...
  string() {
    return utils.utf8.decoder.decode(this.bytes());
  }
  object(id = this.uint()) {
    if (id === 481674261) {
...
exports.TlBinaryReader = TlBinaryReader;
exports.TlUnknownObjectError = TlUnknownObjectError;
