if (typeof globalThis !== "undefined" && !globalThis._MTCUTE_CJS_DEPRECATION_WARNED) {
  ...
  console.warn("[@mtcute/html-parser] CommonJS bundles are deprecated. They will be removed completely in one of the upcoming releases. No support is provided for CommonJS users. Please consider switching to ESM, it's " + (/* @__PURE__ */ new Date()).getFullYear() + " already.");
  console.warn("[@mtcute/html-parser] Learn more about switching to ESM: https://gist.github.com/sindresorhus/a39789f98801d908bbc7ff3ecc99d99c");
}
"use strict";
      ...
      switch (name) {
        ...
        case "tg-time": {
          ...
          entity = {
            ...
            ...attribs.format ? utils_js.parseDateEntityFormat(attribs.format) : {}
          };
          break;
        }
        case "time": {
  ...
  for (let i = entitiesOffset; i < entities.length; i++) {
    ...
    switch (type) {
      ...
      case "messageEntityFormattedDate": {
        const fmt = utils_js.dateEntityFormatToString(entity);
