...
class Sticker extends document.RawDocument {
  ...
  get customEmojiId() {
    if (this.attr._ !== "documentAttributeCustomEmoji") {
      throw new errors.MtArgumentError("This is not a custom emoji");
    }
    return this.raw.id;
  }
  /**
...
const Sticker$1 = /* @__PURE__ */ memoize.memoizeGetters(Sticker, ["fileName", "thumbnails", "fileId", "uniqueFileId", "maskPosition"]);
const Sticker$2 = /* @__PURE__ */ inspectable.makeInspectable(Sticker$1, ["fileSize", "dcId"], ["inputMedia", "inputDocument"]);
exports.MASK_POSITION_POINT_TO_TL = MASK_POSITION_POINT_TO_TL;
exports.Sticker = Sticker$2;
