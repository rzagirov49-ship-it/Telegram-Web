...
async function enableCloudPassword(client, params) {
  ...
  if (pwd.hasPassword) {
    throw new errors.MtArgumentError("Cloud password is already enabled");
  }
