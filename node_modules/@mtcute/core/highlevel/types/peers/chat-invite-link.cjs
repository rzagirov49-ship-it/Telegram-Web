...
class ChatInviteLink {
  constructor(raw, _peers) {
    this._peers = _peers;
    typeAssertions.assertTypeIsNot("ChatInviteLink", raw, "chatInvitePublicJoinRequests");
    this.raw = raw;
  }
  raw;
  /**
  ...
  get creator() {
    ...
    return new user.User(this._peers.user(this.raw.adminId));
  }
  /**
...
const ChatInviteLink$1 = /* @__PURE__ */ memoize.memoizeGetters(ChatInviteLink, ["creator"]);
const ChatInviteLink$2 = /* @__PURE__ */ inspectable.makeInspectable(ChatInviteLink$1);
exports.ChatInviteLink = ChatInviteLink$2;
